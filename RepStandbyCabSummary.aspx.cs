...
using RepStandbyCabSummaryDataSetTableAdapters;

public partial class RepStandbyCabSummary : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptStandbyCabSummaryTableAdapter ds = new RptStandbyCabSummaryTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "RepStandbyCabSummaryReport.rdlc";
        ReportDataSource report1DataSource = new ReportDataSource("RepStandbyCabSummaryDataSet_RptStandbyCabSummary", ds.GetData(Startdate, EndDate, Convert.ToInt32(FacilityID), TripType));
