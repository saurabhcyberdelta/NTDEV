                        ...
                        <table align="center" width="100%">
                            <tr>
                                <td class="heading">
                                    <div class="gradient2">
                                        <h1>
                                            <span></span>Dummy TripSheet Entry
                                        </h1>
                                        <h2>
                                            Allows User to Enter Dummy Tripsheet Details.
                                        </h2>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" DefaultButton="btnSearch">
                                        ...
                                        <td align="left">
                                            <asp:DropDownList ID="ddlSelectFacility" runat="server" AutoPostBack="True" 
                                                ...
                                                <td style="text-align: left">
                                                    <asp:TextBox ID="txtRouteId" runat="server" MaxLength="6" Style="margin-left: 4px"
                                                        CssClass="TextBox" ValidationGroup="Search"></asp:TextBox>
                                                                   ...
                                                                   <table border="1" cellpadding="4" cellspacing="0" width="100%" class="table" style="border: thin solid #000000">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left">
                                                                                ...
                                                                                <asp:Label ID="lblShiftTime" runat="server" Text='<%# Eval("tripType")+"-"+Eval("facility") %>'></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right">
                                                                            ...
                                                                            <td style="text-align: left">
                                                                                <asp:TextBox ID="txtAppKM" runat="server" Enabled="false" MaxLength="6" CssClass="TextBox" Text='<%# Eval("approvedKm") %>'></asp:TextBox>
                                                                        ...
                                                                        <tr valign="middle">
                                                                            ...
                                                                            <td style="text-align: left" valign="middle">
                                                                                ...
                                                                                <cc1:CalendarExtender ID="txtStartTime_CalendarExtender" runat="server" Format="MM/dd/yyyy"
                                                                                    Enabled="True" TargetControlID="txtStartTime" CssClass="cal_Theme1">
                                                                                </cc1:CalendarExtender>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:DropDownList ID="ddlBillingTripType" runat="server" AppendDataBoundItems="True" AutoPostBack="true" 
                                                                                    OnSelectedIndexChanged="ddlBillingTripType_SelectedIndexChanged">
                                                                                </asp:DropDownList>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="3" align="left">
                                                                                ...
                                                                                <asp:Label ID="lblCabType" Font-Bold="true" runat="server" Text='<%# Eval("CabType") %>'></asp:Label>
                                                                            </td>
                                                                            <td>
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <table width="100%" cellpadding="2" cellspacing="0">
                                                                <tr style="background-image: url('images/Grid/row_selected.gif'); background-repeat: repeat-x">
                                                                    <td style="text-align: left" bgcolor="#D6D6D6">
                                                                        <asp:ImageButton ID="imbbtnAddEmp" runat="server" ImageUrl="~/images/Employee.png"
                                                                            CausesValidation="False" OnClick="btnAddEmp_Click" ToolTip="Add Partner" Width="20px"
                                                                            BorderStyle="Ridge" BorderWidth="0px" />
                                                                        <i><b style="text-decoration: underline">Add Partner</b></i>
                                                                    </td>
                                                                    <td style="background-image: url('images/Grid/footer.gif'); background-repeat: repeat; height: 25px; vertical-align: middle; text-align: center;" 
                                                                        bgcolor="#D6D6D6">
                                                                         <asp:ImageButton ID="imgbtnAddUnschedule" runat="server" ImageUrl="~/images/add_employee.gif"
                                                                            CausesValidation="False"  ToolTip="Add Unschedule Partner"
                                                                    ...
                                                                    <td bgcolor="#D6D6D6" style="text-align: right">
                            ...
                            <tr>
                                        ...
                                        <table width="600">
                                            <tr>
                                                <td width="95%" bgcolor="#003366" style="color: #FFFFFF" align="center">
                                                    <b>Allow User to Insert New Partner in the Route.</b>
                                                </td>
                                                <td bgcolor="#003366">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <asp:GridView ID="GvEmployee" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                    ...
                                                                    CssClass="GridView" Visible="False" Width="600px">
                                                                    <Columns>
                                ...
                                <td>
                                    ...
                                    <cc1:ModalPopupExtender ID="ModalPopupExtender2" runat="server" Enabled="True" BackgroundCssClass="modalBackground"
                                        Drag="True" TargetControlID="btnUnscheduleHidden" CancelControlID="ImageButton1" PopupControlID="Panel3">
                                    </cc1:ModalPopupExtender>
                                       <asp:Panel ID="Panel3" runat="server" CssClass="modaltable" DefaultButton="btnEmpSearch"
                                        ...
                                        <table width="600">
                                            <tr>
                                                <td width="95%" bgcolor="#003366" style="color: #FFFFFF" align="center">
                                                    <b>Allow User to Insert Unschedule Partner.</b>
                                                </td>
                                                <td bgcolor="#003366">
                                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/Exit.jpg" OnClick="lbtnClose_Click" />
                                                </td>
                                            </tr>
                                            </table>
                                             <table width="100%" class="tableBorber">
