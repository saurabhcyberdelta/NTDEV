...
using RepStandbyCabConsolidateDataSetTableAdapters;


public partial class RepStandbyCabConsolidate : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptStandbyCabConsolidateTableAdapter ds = new RptStandbyCabConsolidateTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "RepStandbyCabConsolidateReport.rdlc";
        ReportDataSource report1DataSource = new ReportDataSource("RepStandbyCabConsolidateDataSet_RptStandbyCabConsolidate", ds.GetData(Startdate, EndDate, Convert.ToInt32(FacilityID), TripType));
