<%@ Page Title="Guard Deployment Report" Language="C#" MasterPageFile="~/eTMSMaster.Master"
    AutoEventWireup="true" CodeFile="RepGuardDeployment.aspx.cs" Inherits="RepGuardDeployment" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
                 <div class="gradient2">
                                        <h1>
                                            <span></span>  Display Guard Deployment Report
                                        </h1>
                                        <h2>
                                           Allows to Generate Guard Deployment Report.
                                        </h2>
                                    </div>
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="80%"
                                ...
                                <LocalReport ReportPath="RepGuardDeploymentReport.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="RepGuardDeploymentDataSet_RptGuardDeployment" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData"
                                TypeName="RepGuardDeploymentDataSetTableAdapters."></asp:ObjectDataSource>
                        </td>
                    </tr>
                </table>
            </td>
