...
public partial class RepProcesswiseOTA : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptProcesswiseOTATableAdapter ds = new RptProcesswiseOTATableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptProcesswiseOTA", ds.GetData(Startdate, EndDate, Convert.ToInt32(FacilityID)));
