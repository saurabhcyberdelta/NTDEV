<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepNoShow.aspx.cs" Inherits="RepNoShow" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
                                    ...
                                    <div class="gradient2">
                                        <h1>
                                            <span></span>  Detailed No-Show/Cancelled  Report
                                        </h1>
                                        <h2>
                                              Detailed No-Show/Cancelled  Report
                                        </h2>
                                    </div>
                    ...
                    <tr align="center">
                        ...
                        <td align="center" valign="middle" rowspan="2">
                            <asp:RadioButtonList ID="rdbtnType" runat="server">
                                <asp:ListItem Selected="True" Value="N">No-Show</asp:ListItem>
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" 
                                ...
                                <LocalReport ReportPath="RepNoShowReport.rdlc">
                                </LocalReport>
                            </rsweb:ReportViewer>                            
                        </td>
                    </tr>
