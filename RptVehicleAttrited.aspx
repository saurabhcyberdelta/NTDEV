<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RptVehicleAttrited.aspx.cs" Inherits="RptVehicleAttrited" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
              <div class="gradient2">
                                        <h1>
                                            <span></span>Display Vehicle Audit Report
                                        </h1>
                                        <h2>
                        ...
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="100%"
                               ...
                               ShowBackButton="True" ShowFindControls="False"
                                ...
                                <localreport reportpath="RptVehicleAuditLog.rdlc">
                                    <datasources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="RepAttritationDataSet_RepVehicleAuditLog" />
                                    </datasources>
                                </localreport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" TypeName="RepAttritationDataSetTableAdapters.RepVehicleAuditLogTableAdapter">
