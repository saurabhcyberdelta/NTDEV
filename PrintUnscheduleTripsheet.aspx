<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintUnscheduleTripsheet.aspx.cs"
    Inherits="PrintUnscheduleTripsheet" ValidateRequest="True" %>
                    ...
                    page-break-after: always;">
                            <tr>
                                ...
                                bordercolor="#999999" style="border-collapse: collapse">
                                        <tr>
                                            <td width="20%">
                                                <asp:Label ID="lblRouteID" Text='<%# Eval("ID") %>' runat="server" Font-Size="Large"></asp:Label>
                                                <br />
                                                RequestID:-
                                            ...
                                            <td>
                                                <asp:GridView ID="grdViewRouteDetails" AutoGenerateColumns="False" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Partner Detail">
                                                            <ItemTemplate>
                                                                <div style="width: 200px;">
                                                                    <asp:Label ID="lblEmpName" Text='<%# Eval("Employeedet") %>' runat="server"></asp:Label>
                                                                </div>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                        ...
                                                        <asp:TemplateField HeaderText="G">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbgender" runat="server" Text='<%# Eval("Gender") %>' Width="50px"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="center" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Process">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblAddress" runat="server" Text='<%# Eval("Subprocess") %>' Width="100px"></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="center" />
                                                              <HeaderStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                            ...
                                            <td width="30%">
                                                <table cellpadding="2" width="100%" class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                          <b>    <%# DataBinder.Eval(Container.DataItem, "UpdatedAt")%></b>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                            ...
                            <tr>
                            <td align="center">
                            Your unscheduled request would be allocated based on the route & seat availability. Please carry the unscheduled form. Click here to print the form. Thank you. 
                            </td>
                            </tr>
                        </table>
                    </ItemTemplate>
