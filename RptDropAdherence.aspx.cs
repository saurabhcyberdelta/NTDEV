...
public partial class RptDropAdherence : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();

    RptDepartureShiftWisepartnerTableAdapter ds1 = new RptDepartureShiftWisepartnerTableAdapter();
    RptDepartureShiftWiseTableAdapter ds = new RptDepartureShiftWiseTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptDepartureShiftWise", ds.GetData(Startdate, EndDate, Convert.ToInt32(FacilityID)));
        ReportDataSource report2DataSource = new ReportDataSource("Report_RptDepartureShiftWisepartner", ds1.GetData(Startdate, EndDate, Convert.ToInt32(FacilityID)));
