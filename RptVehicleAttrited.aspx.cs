...
public partial class RptVehicleAttrited : basepage
{
    DataClasses1DataContext tms = new DataClasses1DataContext();
    RepVehicleAuditLogTableAdapter ds = new RepVehicleAuditLogTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("RepAttritationDataSet_RepVehicleAuditLog", ds.GetData(startDate, endDate, facId));
