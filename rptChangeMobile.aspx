<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="rptChangeMobile.aspx.cs" Inherits="rptChangeMobile" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
               ...
               <div class="gradient2">
                                        <h1>
                                            <span></span>Display Mobile Changed Partner Details
                                        </h1>
                                        <h2>
                                         </h2>
                                    </div>
