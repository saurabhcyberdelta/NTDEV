<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true"
    CodeFile="RepCabCompliance.aspx.cs" Inherits="RepCabCompliance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table align="center" border="0" width="100%">
        ...
        <tr align="left">
            <td class="gradient2">
              <h1><span></span>Display Cab Penalty Report</h1>  <br />
              <h2> Allows to Generate Cab Penalty Report.</h2>
            </td>
        </tr>
            ...
            <td>
                ...
                <table border="0" cellpadding="4" cellspacing="0" align="left" width="90%" class="tableBorber">
                    ...
                    <tr align="center">
                        ...
                        <td align="left" rowspan="2" valign="middle" style="display:none">
                    ...
                    <tr align="center">
                        ...
                        <td align="left" valign="top">
                            <%--<asp:ListBox ID="ddlVendor" runat="server" Height="54px" Value="0" 
                            ...
                            <asp:DropDownList ID="ddlVendor" runat="server" AppendDataBoundItems="True">
                                ...
                                <asp:ListItem Value="0" Text="-All Vendor-"></asp:ListItem>
                            </asp:DropDownList>
                            <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="ddlVendor"
                                ErrorMessage="Select Vendor" Operator="NotEqual" ValidationGroup="Submit" ValueToCompare="-1">*</asp:CompareValidator>
                        </td>
                         <td align="left" valign="top" style="display:none">
                            <asp:DropDownList ID="ddlPenaltyType" runat="server" AppendDataBoundItems="True" CssClass="DropDownListBox3"
                                AutoPostBack="False" >
                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                 <asp:ListItem Text="Operations" Value="1"></asp:ListItem>
                                  <asp:ListItem Text="Compliance" Value="2"></asp:ListItem>
                            </asp:DropDownList>
                             <%--<asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="ddlPenaltyType"
                                Display="Dynamic" ErrorMessage="Select PenaltyType" Operator="NotEqual" ValidationGroup="Submit"
                                ValueToCompare="0" SetFocusOnError="True">*</asp:CompareValidator>--%>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td>
                <table align="left" style="width: 147%">
                    <tr>
                        <td align="left">
                           <asp:GridView ID="GvComplianceReport" runat="server" 
                                onrowdatabound="GvComplianceReport_RowDataBound" Visible="False">
