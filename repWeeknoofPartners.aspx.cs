...
public partial class repWeeknoofPartners : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptWeekNoofPaertnersTableAdapter ds = new RptWeekNoofPaertnersTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptWeekNoofPaertners", ds.GetData(Convert.ToInt32(FacilityID), Convert.ToDateTime(Startdate)));
