...
public partial class RepCabsKmAwarding : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RepCabKmAwardingTableAdapter ds = new RepCabKmAwardingTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "RepCabKmAwarding.rdlc";
        ReportDataSource report1DataSource = new ReportDataSource("RPtBillingDataSet_RepCabKmAwarding", ds.GetData(Convert.ToDateTime(Startdate), Convert.ToDateTime(EndDate), Convert.ToInt32(FacilityID), Cabids, Convert.ToInt32(rdbtnWeektype.SelectedValue),Convert.ToInt32(ddlbillingtripType.SelectedValue)));
