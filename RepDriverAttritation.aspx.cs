...
public partial class RepDriverAttritation : basepage
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (rdbType.SelectedValue=="1")
        {
            ...
            ReportDataSource report1DataSource = new ReportDataSource("RepAttritationDataSet_RepDriverAttrited", ds.GetData(startDate, endDate, facId));
        ...
        else
        {
            ...
            gv.DataSource = tms.spruserRightAuditLog(startDate, endDate,Convert.ToInt32(ddlFacility.SelectedValue));
            gv.DataBind();
            GridViewExportUtil.Export("AccessRightAuditLog_"+DateTime.Now+".xls", gv);
        }
