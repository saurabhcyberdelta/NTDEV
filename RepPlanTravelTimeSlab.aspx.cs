...
public partial class RepPlanTravelTimeSlab : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptPlanTravelTimeSlabTableAdapter ds = new RptPlanTravelTimeSlabTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptPlanTravelTimeSlab", ds.GetData(Startdate, EndDate, Convert.ToInt32(FacilityID)));
