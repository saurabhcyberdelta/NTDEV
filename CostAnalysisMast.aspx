<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="CostAnalysisMast.aspx.cs" Inherits="CostAnalysisMast" %>
     ...
     <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
                <div class="gradient2">
                    <h1>
                        <span></span>Cost Analysis Master
                    </h1>
                    <h2>
                        Allows to Add/Delete Cost Analysis
                    </h2>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td align="center">
             ...
             <center> <asp:LinkButton ID="lbtn_AddTemplate" runat="server" 
                    onclick="lbtn_AddTemplate_Click">Add New Cost Analysis</asp:LinkButton></center>
