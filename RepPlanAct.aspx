<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepPlanAct.aspx.cs" Inherits="RepPlanAct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
                Display Plan Vs Actual Information
                <br />
            </td>
        </tr>
        <tr>
            <td align="center" class="subHeading">
                Allows to Generate Plan Vs Actual Report.
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <tr>
                        <td align="left">
                                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="100%"
                                    Font-Names="Verdana" Font-Size="8pt" Style="margin-bottom: 30px" OnDrillthrough="ReportViewer1_Drillthrough"
                                    ...
                                    <LocalReport ReportPath="RepPlanActReport.rdlc">
                                        <DataSources>
                                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                                Name="RepPlanActDataSet_RptPlanAct" />
                                        </DataSources>
                                    </LocalReport>
                                </rsweb:ReportViewer>
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    SelectMethod="GetData" 
                                    TypeName="RepPlanActDataSetTableAdapters.RptPlanActTableAdapter">
