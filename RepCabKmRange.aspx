<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepCabKmRange.aspx.cs" Inherits="RepCabKmRange" %>
 ...
 <table align="center" border="0" width="100%">
        ...
        <tr align="center">
         <td class="heading">
                                    <div class="gradient2">
                                        <h1>
                                            <span></span>Cab KM Range Report
                                        </h1>
                                        <h2>
                                              Allows to Generate Cab Details within the Km Range Given.
                                        </h2>
                                    </div>
                                </td>
           </tr>
        <tr>
            <td>
                ...
                <table border="0" cellpadding="4" cellspacing="0" align="left" width="100%" class="tableBorber">
                    <tr>
                        <td align="center" class="TDbg" colspan="9">
                    ...
                    <tr align="center">
                       ...
                       <td align="left"  valign="top" class="style7">
                           ...
                           <td align="left" rowspan="2" valign="middle">
                               <asp:RadioButtonList ID="rdbtnOperator" runat="server" 
                                   RepeatDirection="Horizontal">
                               <asp:ListItem Text="Less" Value="1" Selected="True"></asp:ListItem>
                               <asp:ListItem Text="Greater" Value="0" ></asp:ListItem>
                    ...
                    <tr align="center">
                        ...
                        <td align="left" valign="top">
                            <asp:DropDownList ID="ddlFacility" runat="server" AppendDataBoundItems="True" 
                                CssClass="DropDownListBox3" AutoPostBack="True" onselectedindexchanged="ddlFacility_SelectedIndexChanged" 
                                >
                            </asp:DropDownList>
                        ...
                        <td align="left" valign="top">
                        <asp:TextBox ID="txtvalue" runat="server" CssClass="TextBox" MaxLength="3"></asp:TextBox>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Value"
                                ControlToValidate="txtvalue" ValidationGroup="Submit" >*</asp:RequiredFieldValidator>
                          <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtvalue"
                                Display="Dynamic" ErrorMessage="Enter Valid Range"  ValidationExpression="^[0-9]*$"
                                ValidationGroup="Submit">*</asp:RegularExpressionValidator>
                        ...
                        <td align="left">
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Width="100%">
                                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="100%"
                                    ...
                                    <LocalReport ReportPath="RepCabkmRnge.rdlc">
                                        <DataSources>
                                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                                Name="RPtBillingDataSet_RepCabKmRange" />
                                        </DataSources>
                                    </LocalReport>
                                </rsweb:ReportViewer>
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    SelectMethod="GetData" 
                                    TypeName="RPtBillingDataSetTableAdapters.RepCabKmRangeTableAdapter">
