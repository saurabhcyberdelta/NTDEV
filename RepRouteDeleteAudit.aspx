<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepRouteDeleteAudit.aspx.cs" Inherits="RepRouteDeleteAudit" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
               ...
               <div class="gradient2">
                                        <h1>
                                            <span></span>Display Route Deletion Audit Log
                                        </h1>
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="100%"
                                ...
                                <LocalReport ReportPath="RepDeletionRouteAudit.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="Report_RptRouteDeletionAuditLog" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" 
                                TypeName="ReportTableAdapters.RptRouteDeletionAuditLogTableAdapter">
