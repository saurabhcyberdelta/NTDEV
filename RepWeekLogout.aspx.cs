...
public partial class RepWeekLogout : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptWeekLogoutOTDTableAdapter ds = new RptWeekLogoutOTDTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptWeekLogoutOTD", ds.GetData(Convert.ToInt32(FacilityID), Convert.ToDateTime(Startdate)));
