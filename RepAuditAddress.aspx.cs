...
using AuditTrailDatasetTableAdapters;
using Microsoft.Reporting.WebForms;

public partial class RepAuditAddress : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptAuditAddresschangeCountTableAdapter ds = new RptAuditAddresschangeCountTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("AuditTrailDataset_RptAuditAddresschangeCount", ds.GetData(Convert.ToDateTime(Startdate), Convert.ToDateTime(EndDate), Convert.ToInt32(FacilityID)));
