<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RptVendorAttrited.aspx.cs" Inherits="RptVendorAttrited" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
              <div class="gradient2">
                                        <h1>
                                            <span></span>Display Vendor Audit Report
                                        </h1>
                                        <h2>
                    ...
                    <tr>
                        <td align="left" width="100%">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="100%"
                                Font-Names="Verdana" Font-Size="8pt" ShowBackButton="True" ShowFindControls="False"
                                ShowPrintButton="False" ShowZoomControl="False" >
                                <localreport reportpath="RptVendorAuditLog.rdlc">
                                    <datasources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="RepAttritationDataSet_RepVendorAuditLog" />
                                    </datasources>
                                </localreport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" TypeName="RepAttritationDataSetTableAdapters.RepVendorAuditLogTableAdapter">
