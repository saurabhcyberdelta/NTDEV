<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RptDropAdherence.aspx.cs" Inherits="RptDropAdherence" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
               ...
               <div class="gradient2">
                                        <h1>
                                            <span></span>Display Drop Adherence Report
                                        </h1>
                                        <h2>
                                             Allows to Generate Drop Adherence Report.
                                        </h2>
                                    </div>
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="80%"
                                ...
                                <LocalReport ReportPath="RepArrivalShiftWiseDepReport.rdlc">
                                   
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" 
                                TypeName="ReportTableAdapters.RptDepartureShiftWisepartnerTableAdapter">
