<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepUnscheduleRequest.aspx.cs" Inherits="RepUnscheduleRequest" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
                                    ...
                                    <div class="gradient2">
                                        <h1>
                                            <span></span>  Detailed Unschedule Request Report
                                        </h1>
                                        <h2>
                                           Detailed Unschedule Request Report
                                        </h2>
                                    </div>
                    ...
                    <tr align="center">
                        ...
                        <td align="left" valign="top">
                            ...
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="ddlType"
                                Display="Dynamic" ErrorMessage="Select Type" Operator="NotEqual" ValidationGroup="Submit"
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" 
                                Width="100%" Font-Names="Verdana"  ShowFindControls="False" 
                                ShowPrintButton="False" SizeToReportContent="True" 
                                ShowZoomControl="False" AsyncRendering="False" >
                                <LocalReport ReportPath="RepUnschedRequest.rdlc">
                                </LocalReport>
                            </rsweb:ReportViewer>                            
                        </td>
                    </tr>
