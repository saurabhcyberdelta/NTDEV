<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="ReportMaster.aspx.cs" Inherits="ReportMaster" %>
                ...
                <table border="0" cellpadding="4" cellspacing="0" align="left" width="90%" class="tableBorber">
                    ...
                    <tr align="center">
                        ...
                        <td align="left" valign="top">
                          ...
                          <td align="left" valign="top">
                            <asp:DropDownList ID="ddlReport" runat="server" AppendDataBoundItems="True" CssClass="DropDownListBox3">
                            </asp:DropDownList>
                            <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="ddlReport"
                                Display="Dynamic" ErrorMessage="Select Report Name" Operator="NotEqual" ValidationGroup="Submit"
                                ValueToCompare="0" SetFocusOnError="True">*</asp:CompareValidator>
                        </td>
                    </tr>
                </table>
