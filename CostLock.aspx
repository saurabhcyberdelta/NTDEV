<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="CostLock.aspx.cs" Inherits="CostLock" %>
 ...
 <table align="center" border="0" width="100%">
        ...
        <tr align="center">
         <td class="heading">
                                    <div class="gradient2">
                                        <h1>
                                            <span></span>Lock The Total Cost
                                        </h1>
                                        <h2>
                                              Allows to Lock Total Transport Cost Report.
                                        </h2>
                                    </div>
                                </td>
           </tr>
        ...
        <tr>
            <td>
                <table align="left" width="90%">
                    <tr>
                    <td align="center">
                     <asp:Button ID="btnLockCost" runat="server" Text="Lock Cost"  CssClass="Button" 
                            Visible="false" onclick="btnLockCost_Click"/>
                            <asp:Button ID="btnunlock" runat="server" Text="UnLock Cost"  CssClass="Button" 
                        ...
                        <td align="left">
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Width="100%">
                                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="100%"
                                    ...
                                    <LocalReport ReportPath="RptTotalCost.rdlc">
                                        <DataSources>
                                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                                Name="RPtBillingDataSet_ReptotalCost" />
                                        </DataSources>
                                    </LocalReport>
                                </rsweb:ReportViewer>
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    SelectMethod="GetData" 
                                    TypeName="RPtBillingDataSetTableAdapters.ReptotalCostTableAdapter">
