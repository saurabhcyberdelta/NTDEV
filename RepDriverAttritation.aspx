<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepDriverAttritation.aspx.cs" Inherits="RepDriverAttritation" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
              <div class="gradient2">
                                        <h1>
                                            <span></span>Display Driver Attrited Report
                                        </h1>
                                        <h2>
                                               Allows to Generate Driver Attrited Report.
                                        </h2>
                                    </div>
                    ...
                    <tr align="center">
                        ...
                        <td align="center" valign="middle" rowspan="2">
                            <asp:RadioButtonList id="rdbType" runat="server">
                                <asp:ListItem Text="Driver Audit Log" Value="1" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="Access Right Audit Log" Value="2"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
        ...
        <tr>
            <td>
                <table align="left" width="80%">
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="80%"
                                Font-Names="Verdana" Font-Size="8pt" Height="1000px" SizeToReportContent="True"
                                AsyncRendering="False" ShowBackButton="True" ShowFindControls="False"
                                ShowPrintButton="False" ShowZoomControl="False" ZoomMode="FullPage">
                                <LocalReport ReportPath="RptDriverAuditLog.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="RepAttritationDataSet_RepDriverAttrited" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" TypeName="RepAttritationDataSetTableAdapters.RepDriverAttritedTableAdapter">
