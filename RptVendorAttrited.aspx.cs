...
public partial class RptVendorAttrited : basepage
{
    DataClasses1DataContext tms = new DataClasses1DataContext();
    RepVendorAuditLogTableAdapter ds = new RepVendorAuditLogTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("RepAttritationDataSet_RepVendorAuditLog", ds.GetData(startDate, endDate, facId));
