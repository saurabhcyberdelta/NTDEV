<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepArrivalSlab.aspx.cs" Inherits="RepArrivalSlab" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
               ...
               <div class="gradient2">
                                        <h1>
                                            <span></span>Display Weekly Arrival slab
                                        </h1>
                                        <h2>
                                             Allows to Display Weekly Arrival Slab
                                        </h2>
                                    </div>
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="80%"
                                ...
                                <LocalReport ReportPath="RepArrivalpartSlab.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="Report_RptWeekArrivalSlab" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" 
                                TypeName="ReportTableAdapters.RptWeekArrivalSlabTableAdapter">
