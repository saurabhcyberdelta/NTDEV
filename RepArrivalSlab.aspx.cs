...
public partial class RepArrivalSlab : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptWeekArrivalSlabTableAdapter ds = new RptWeekArrivalSlabTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptWeekArrivalSlab", ds.GetData(Convert.ToInt32(FacilityID), Convert.ToDateTime(Startdate)));
