<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepAuditAddress.aspx.cs" Inherits="RepAuditAddress" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
              <div class="gradient2">
                                        <h1>
                                            <span></span>Display Address Change Count
                                        </h1>
                                        <h2>
                                               Allows to Generate No of times partners have changed the address.
                                        </h2>
                                    </div>
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="80%"
                                ...
                                <LocalReport ReportPath="RptadressChangecount.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="AuditTrailDataset_RptAuditAddresschangeCount" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" 
                                TypeName="AuditTrailDatasetTableAdapters.RptAuditAddresschangeCountTableAdapter">
