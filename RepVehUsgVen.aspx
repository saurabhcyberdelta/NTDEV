<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true"
    CodeFile="RepVehUsgVen.aspx.cs" Inherits="RepVehUsgVen" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr>
            <td align="center" class="subHeading">
                Allows to Generate Seat Utilization Report.
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="100%"
                                Font-Names="Verdana" Font-Size="8pt" Style="margin-bottom: 30px" ShowBackButton="True"
                                ShowFindControls="False" ShowPrintButton="False" Height="400px" 
                                AsyncRendering="False" ShowZoomControl="False" SizeToReportContent="True" 
                                ZoomMode="FullPage">
                                <LocalReport ReportPath="RepVehUsgVenReport.rdlc">
                                </LocalReport>
                            </rsweb:ReportViewer>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            <%--<rsweb:ReportViewer ID="ReportViewer2" runat="server" Visible="False" Width="100%"
                                Font-Names="Verdana" Font-Size="8pt" Style="margin-bottom: 30px" ShowBackButton="True"
                                ShowFindControls="False" ShowPrintButton="False" Height="400px" 
                                AsyncRendering="False" ShowZoomControl="False" SizeToReportContent="True" 
                                ZoomMode="FullPage">
                                <LocalReport ReportPath="RepVehUsageVeh.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="RepVehUsgVenDataSet_RptVehUsgVen" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>--%>
                                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                            SelectMethod="GetData" TypeName="RepVehUsgVenDataSetTableAdapters.">
