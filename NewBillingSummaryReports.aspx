<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="NewBillingSummaryReports.aspx.cs" Inherits="NewBillingSummaryReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" border="0">
        ...
        <tr align="center">
            <td class="heading">Billing Summary Report<br />
            </td>
        </tr>
        <tr>
            <td align="center" class="subHeading">Allows to Generate Billing Summary Report.
            </td>
        </tr>
        <tr>
            <td align="center">
                    ...
                    <tr align="center">
                        ...
                        <td align="left" rowspan="2" valign="middle">
                            <asp:RadioButtonList ID="rdbreptype" runat="server">
                                <asp:ListItem Text="Slab Billing" Value="1" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="Medical Billing" Value="2"></asp:ListItem>
                                <%--<asp:ListItem Text="Additional Billing" Value="3"></asp:ListItem>--%>
                                <asp:ListItem Text="FTE-LTE-20 Billing" Value="4"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td align="left" rowspan="2" valign="middle">
        ...
        <tr>
            <td align="center">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="800px"
                    ...
                    <%--<LocalReport ReportPath="SlabBillingSummary.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                Name="RPtBillingDataSet_SlabBillingSummary" />
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource2" 
                                Name="RPtBillingDataSet_MedicalBillingSummary" />
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource2" 
                                Name="RPtBillingDataSet_AdditionalBillingSummary" />
                        </DataSources>
                    </LocalReport>--%>
                </rsweb:ReportViewer>
                <%--<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    SelectMethod="GetData" TypeName="RPtBillingDataSetTableAdapters.SlabBillingSummaryTableAdapter">
                </asp:ObjectDataSource>
                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                    SelectMethod="GetData" TypeName="RPtBillingDataSetTableAdapters.MedicalBillingSummaryTableAdapter">
                </asp:ObjectDataSource>
                <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" 
                    SelectMethod="GetData" TypeName="RPtBillingDataSetTableAdapters.AdditionalBillingSummaryTableAdapter">
                </asp:ObjectDataSource>--%>
                <br />
