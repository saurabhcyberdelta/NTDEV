...
public partial class RepFinalCost : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RepFinalBillTransportTableAdapter ds = new RepFinalBillTransportTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "RepFinalBillTransport.rdlc";
        ReportDataSource report1DataSource = new ReportDataSource("RPtBillingDataSet_RepFinalBillTransport", ds.GetData(Convert.ToDateTime(Startdate), Convert.ToDateTime(EndDate), Convert.ToInt32(FacilityID), Cabids,Convert.ToInt32(ddlVendor.SelectedValue),Convert.ToInt32(0)));
