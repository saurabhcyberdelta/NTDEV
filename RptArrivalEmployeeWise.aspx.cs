...
public partial class RptArrivalEmployeeWise : basepage
{

    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptArrivalEmployeeWiseTableAdapter ds = new RptArrivalEmployeeWiseTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptArrivalEmployeeWise", ds.GetData(Convert.ToDateTime(Startdate),Convert.ToDateTime(EndDate), Convert.ToInt32(FacilityID)));
