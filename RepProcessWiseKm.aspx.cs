...
public partial class RepProcessWiseKm : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    repProcesswisekmTableAdapter ds = new repProcesswisekmTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "RptProcessWisekm.rdlc";

        ReportDataSource report1DataSource = new ReportDataSource("Report_repProcesswisekm", ds.GetData(Convert.ToDateTime(Startdate),Convert.ToDateTime(EndDate), Convert.ToInt32(FacilityID), TripType));
        ReportViewer1.LocalReport.DataSources.Clear();
