...
public partial class RepRouteDeleteAudit : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptRouteDeletionAuditLogTableAdapter ds=new RptRouteDeletionAuditLogTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptRouteDeletionAuditLog", ds.GetData(Convert.ToDateTime(Startdate), Convert.ToInt32(FacilityID)));
