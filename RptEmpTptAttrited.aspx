<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RptEmpTptAttrited.aspx.cs" Inherits="RptEmpTptAttrited" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
              <div class="gradient2">
                                        <h1>
                                            <span></span>Partner Toop Audit Log
                                        </h1>
                                        <h2>
                                               Allows to Generate Employee Attrited Report.
                                        </h2>
                                    </div>
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="100%"
                                Font-Names="Verdana" Font-Size="8pt" Height="1000px" AsyncRendering="true" 
                                SizeToReportContent="true"
                                ShowPrintButton="False" ShowZoomControl="False"  >
                                <LocalReport ReportPath="RepEmpToopAuditLog.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="RepAttritationDataSet_RptEmpToopAuditLog" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" TypeName="RepAttritationDataSetTableAdapters.RptEmpToopAuditLogTableAdapter">
