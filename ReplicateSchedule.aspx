<%@ Page Title="Replicate Schedule" Language="C#" MasterPageFile="~/Header.Master"
    AutoEventWireup="true" CodeFile="ReplicateSchedule.aspx.cs" Inherits="ReplicateSchedule"
                            ...
                            <tr>
                                ...
                                <td align="center" class="heading" colspan="2">
                                    <div class="gradient2">
                                        ...
                                        <h2>
                                            Allows Spoc/Manager to Replicate Schedule.
                                        </h2>
                                    </div>
                                </td>
                            </tr>
                ...
                <tr>
                    <td>
                        <table align="left" cellpadding="3" cellspacing="0" width="100%">
                            <tr>
                                <td align="right">
                                    <asp:CustomValidator ID="CustomValidatorCheckBox" runat="server" ErrorMessage="Cannot proceed because you did not choose any employee."
