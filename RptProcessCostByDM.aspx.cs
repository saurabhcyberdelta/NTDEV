...
public partial class RptProcessCostByDM : basepage
{
    DataClasses1DataContext tms = new DataClasses1DataContext();
    repProcessWiseCostTableAdapter ds = new repProcessWiseCostTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("RepProcessWiseCost_repProcessWiseCost", ds.GetData(startDate, endDate, facId));
