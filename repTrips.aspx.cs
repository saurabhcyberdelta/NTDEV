...
public partial class repTrips : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    rpTripCountTableAdapter ds = new rpTripCountTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_rpTripCount", ds.GetData(Convert.ToDateTime(Startdate), Convert.ToDateTime(EndDate), Convert.ToInt32(FacilityID)));
