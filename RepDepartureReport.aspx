<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepDepartureReport.aspx.cs" Inherits="RepDepartureReport" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
              <div class="gradient2">
                                        <h1>
                                            <span></span>Display On Time Departue Employee Report
                                        </h1>
                                        <h2>
                                               Allows to Generate  On Time Departure Employee Report.
                                        </h2>
                                    </div>
