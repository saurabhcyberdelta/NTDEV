...
using RptNoShowDataSetTableAdapters;
using Microsoft.Reporting.WebForms;

public partial class RepNoShow : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptNoshowTableAdapter ds = new RptNoshowTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource reportDataSource = new ReportDataSource("RptNoShowDataSet_RptNoshow", ds.GetData(Startdate, EndDate, FacilityID, TripType, Shifttimes,rdbtnType.SelectedValue));
