...
public partial class RepWeekLogin : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptWeekLoginOTATableAdapter ds = new RptWeekLoginOTATableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptWeekLoginOTA", ds.GetData(Convert.ToInt32(FacilityID), Convert.ToDateTime(Startdate)));
