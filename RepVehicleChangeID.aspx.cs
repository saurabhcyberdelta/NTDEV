...
public partial class RepVehicleChangeID : System.Web.UI.Page
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RepVehiclechangeIDReportTableAdapter ds = new RepVehiclechangeIDReportTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string Cabids = string.Empty;
         ReportViewer1.LocalReport.ReportPath = "RepVehicleChange.rdlc";
         ReportDataSource report1DataSource = new ReportDataSource("RPtBillingDataSet_RepVehiclechangeIDReport", ds.GetData(Convert.ToDateTime(Startdate), Convert.ToDateTime(EndDate), Convert.ToInt32(FacilityID)));
