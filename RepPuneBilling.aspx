<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true"
    CodeFile="RepPuneBilling.aspx.cs" Inherits="RepArrivalShiftWise" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
                <div class="gradient2">
                    <h1>
                        <span></span>Display Pune Billing
                    </h1>
                    <h2>
                        Allows to Generate Billing Report.
                    </h2>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td align="left">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="80%"
                    ...
                    AsyncRendering="False" ShowBackButton="True" ShowFindControls="False" ShowPrintButton="False"
                    ShowZoomControl="False" ZoomMode="FullPage">
                    <LocalReport ReportPath="RepPuneBilling.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                Name="RPtBillingDataSet_SPR_PuneBillingDetails" />
                        </DataSources>
                    </LocalReport>
                </rsweb:ReportViewer>
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData"
                    TypeName="RPtBillingDataSetTableAdapters.SPR_PuneBillingDetailsTableAdapter">
