<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepPlanTravelTimeSlab.aspx.cs" Inherits="RepPlanTravelTimeSlab" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
              <div class="gradient2">
                                        <h1>
                                            <span></span>Display Planed Travel Time Slab Report
                                        </h1>
                                        <h2>
                                               Allows to Generate Planed Travel Time Slab Report.
                                        </h2>
                                    </div>
        ...
        <tr>
            <td>
                <table align="left" width="80%">
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="false" Width="47%" 
                                Font-Names="Verdana" Font-Size="8pt" Height="59px" SizeToReportContent="True"
                                ...
                                <localreport reportpath="RptPlanTravelTimeSlab.rdlc">
                                    <datasources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="Report_RptPlanTravelTimeSlab" />
                                    </datasources>
                                </localreport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" 
                                TypeName="ReportTableAdapters.RptPlanTravelTimeSlabTableAdapter">
