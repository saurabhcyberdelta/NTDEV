...
public partial class RepArrivalShiftWise : basepage
{
    ...
    RptArrivalShiftWiseTableAdapter ds = new RptArrivalShiftWiseTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("RepArrivalShiftWiseDataSet_RptArrivalShiftWise", ds.GetData(Startdate, EndDate, Convert.ToInt32(FacilityID)));
