<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="tripBasisCostMaster.aspx.cs" Inherits="tripBasisCostMaster" %>
            ...
            <table align="center" width="100%">
                ...
                <tr>
                    <td class="heading">
                        <div class="gradient2">
                            <h1>
                                <span></span>Trip Basis Cost Master
                            </h1>
                            <h2>
                                Allows User to View/Edit and Add New Km Cost for Trip Basis.
                            </h2>
                        </div>
                    </td>
                </tr>
                                                                    ...
                                                                    &nbsp;<asp:GridView ID="gvCost" runat="server" AllowSorting="True"
                                                                        ...
                                                                        <Columns>
                                                                           ...
                                                                           <asp:TemplateField HeaderText="Fuel Rate">
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Non-AC Rate/Trip">
                                                                               
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblKmRate" runat="server" Text='<%# Eval("TripRate") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="AC Rate/Trip">
