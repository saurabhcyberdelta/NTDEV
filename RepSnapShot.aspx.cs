...
public partial class RepSnapShot : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptsnapShotTableAdapter ds = new RptsnapShotTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptsnapShot", ds.GetData(Startdate,Convert.ToInt32(FacilityID)));
