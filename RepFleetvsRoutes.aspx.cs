...
public partial class RepFleetvsRoutes : System.Web.UI.Page
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptFleetvsRoutesTableAdapter ds = new RptFleetvsRoutesTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "RepFeet.rdlc";
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptFleetvsRoutes", ds.GetData(Convert.ToDateTime(Startdate),Convert.ToInt32(FacilityID),triptype));
