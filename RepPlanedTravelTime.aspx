<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="RepPlanedTravelTime.aspx.cs" Inherits="RepPlanedTravelTime" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
              <div class="gradient2">
                                        <h1>
                                            <span></span>Display Cab On Planed Time Arrival Vendor Report
                                        </h1>
                                        <h2>
                                               Allows to Generate Cab On Planed Time Arrival Vendor Report.
                                        </h2>
                                    </div>
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Width="80%"
                                ...
                                <LocalReport ReportPath="RepPlanTravelTime.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                                            Name="Report_RptPlanedTravelTime" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                SelectMethod="GetData" 
                                TypeName="ReportTableAdapters.RptPlanedTravelTimeTableAdapter" 
