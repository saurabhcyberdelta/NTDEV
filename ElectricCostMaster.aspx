<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="ElectricCostMaster.aspx.cs" Inherits="ElectricCostMaster" %>
            ...
            <table align="center" width="100%">
                ...
                <tr>
                    <td class="heading">
                        <div class="gradient2">
                            <h1>
                                <span></span>Electric Cab Cost Master
                            </h1>
                            <h2>
                                Allows User to View/Edit and Add New Cost for Electric Cab.
                            </h2>
                        </div>
                    </td>
                </tr>
