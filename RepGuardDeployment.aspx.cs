...
using RepGuardDeploymentDataSetTableAdapters;
using Microsoft.Reporting.WebForms;

public partial class RepGuardDeployment : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptGuardDeploymentTableAdapter ds = new RptGuardDeploymentTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("RepGuardDeploymentDataSet_RptGuardDeployment", ds.GetData(Startdate, EndDate, Convert.ToInt32(FacilityID)));
