...
public partial class RepTravelTime : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptTravelTimeTableAdapter ds = new RptTravelTimeTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptTravelTime", ds.GetData(Startdate, EndDate, Convert.ToInt32(FacilityID)));
