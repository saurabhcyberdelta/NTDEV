...
public partial class rptChangeMobile : basepage
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        GridView1.DataSource = tmscontext.rptChangedMobilePartner(Convert.ToDateTime(Startdate), Convert.ToDateTime(EndDate), Convert.ToInt32(ddlFacility.SelectedValue));
        GridView1.DataBind();
        GridViewExportUtil.Export("MobileChange.xls", GridView1);
