...
public partial class RepWeekNoroutes : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptWeekNoofRoutesTableAdapter ds = new RptWeekNoofRoutesTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("Report_RptWeekNoofRoutes", ds.GetData(Convert.ToInt32(FacilityID),Convert.ToDateTime(Startdate)));
