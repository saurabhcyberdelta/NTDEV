<%@ Page Title="" Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true" CodeFile="BillingInvoiceReports.aspx.cs" Inherits="BillingInvoiceReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center" border="0">
        ...
        <%--<tr align="center">
            <td class="heading">Vendor Invoice Summary<br />
            </td>
        </tr>
        <tr>
            <td align="center" class="subHeading">Allows to Generate Vendor Invoice Summary.
            </td>
        </tr>--%>
        <tr>
            <td class="auto-style1">
                <strong>Checklist before generating invoice summary:</strong><br />
                <span class="auto-style2"><em style="color:red">
                <br />
                Please assign the costing in the MGK200 Slab cost master and Medical cost master.</em></span><em><br class="auto-style2" />
                </em><span class="auto-style2" style="color:red"><em>Please generate slab cost calculation report from Detailed billing for both the facilities MAN and ECO 
                (weekdays and weekends) before generating invoice.</em></span><em><br class="auto-style2" />
                </em><span class="auto-style2" style="color:red"><em>After completing above steps if the costing is not appearing or showing as zero for any billing model it 
                means the vendor is not running under it.<br />
                </em></span>
                <br />
            </td>
        </tr>
                    ...
                    <tr align="center">
                        ...
                        <td align="left" valign="top">
                            ...
                            <asp:DropDownList runat="server" ID="rdbreptype" AppendDataBoundItems="True" CssClass="DropDownListBox3">
                                ...
                                <asp:ListItem Text="Vendor Invoice Summary" Value="1" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="GVT Invoice Summary" Value="2"></asp:ListItem>
                                <asp:ListItem Text="Pune Invoice Summary" Value="3"></asp:ListItem>
                                <%--<asp:ListItem Text="Slab Cost Calculation" Value="4"></asp:ListItem>
                                <asp:ListItem Text="Medical Billing" Value="2"></asp:ListItem>
                                <%--<asp:ListItem Text="Additional Billing" Value="3"></asp:ListItem>
                                <asp:ListItem Text="FTE-LTE-20 Billing" Value="5"></asp:ListItem>
            ...
            <asp:MultiView ID="MultiView1" runat="server">
                <asp:View ID="View1" runat="server">
                    <table align="center">                        
                       <tr>
                           <td align="left">
                               <asp:LinkButton ID="lbtnPritGuardSheet" runat="server" OnClick="lbtnPritGuardSheet_Click">Export To Excel</asp:LinkButton>
                           </td>
                       </tr>
                        <tr>
                            <td align="center">
                                <asp:GridView ID="GVNOSReport" runat="server" AutoGenerateColumns="False" DataKeyNames="Particulars"
                                    AllowPaging="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Trip Rate">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTripRate" runat="server" Text='<%# Eval("TripRate") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Total Cost">
                                            ...
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTtlCost" runat="server" Text='<%# Eval("TotalCost") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <%--<asp:TemplateField HeaderText="TripRate">
                                            ...
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblLicenseNo" runat="server" Text='<%# Eval("TripRate") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="TotalCostNOS">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotalCostNOS" runat="server" Text='<%# Eval("TotalCostNOS") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="TotalCostNOL">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotalCostNOL" runat="server" Text='<%# Eval("TotalCostNOL") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Totalcost">
                                            ...
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotalcoste" runat="server" Text='<%# Eval("Totalcost") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                    </Columns>
                                    <FooterStyle CssClass="FooterStyle" BackColor="#CCCCCC" ForeColor="Black" />
                                    ...
                                    <SelectedRowStyle CssClass="SelectedRowStyle" BackColor="#008A8C" Font-Bold="True"
                                        ForeColor="White" />
                                    <HeaderStyle CssClass="HeaderStyle" BackColor="#000084" Font-Bold="True" ForeColor="Black" />
                ...
                <asp:View ID="View2" runat="server">
                    <table align="center">                        
                       <tr>
                           <td align="left">
                               <asp:LinkButton ID="lnkPrintNOSNOL" runat="server" OnClick="lnkPrintNOSNOL_Click">Export To Excel</asp:LinkButton>
                           </td>
                       </tr>
                        <tr>
                            <td align="center">
                                <asp:GridView ID="NOSNOLRptGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="Particulars"
                                    AllowPaging="False"
                                    BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px"
                                    CellPadding="5">
                                    <RowStyle BackColor="#EEEEEE" ForeColor="Black" />
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Trips With NOS">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTripsNOS" runat="server" Text='<%# Eval("TripsFromNOS") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Trips With NOL">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTripsNOL" runat="server" Text='<%# Eval("TripsFromNOL") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Trips With NOS+NOL">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTripsNOL" runat="server" Text='<%# Eval("TripsWithNOSandNOL") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Employees From NOS">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblempNOS" runat="server" Text='<%# Eval("EmployeesFromNOS") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Employees From NOL">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblempNOL" runat="server" Text='<%# Eval("EmployeesFromNOL") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Fuel Rate">
                                        ...
                                        <asp:TemplateField HeaderText="Total Cost NOS">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotalCostNOS" runat="server" Text='<%# Eval("TotalCostNOS") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Total Cost NOL">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotalCostNOL" runat="server" Text='<%# Eval("TotalCostNOL") %>'></asp:Label>
                                    ...
                                    <SelectedRowStyle CssClass="SelectedRowStyle" BackColor="#008A8C" Font-Bold="True"
                                        ForeColor="White" />
                                    <HeaderStyle BackColor="#b5c9d9" Font-Bold="True" ForeColor="Black" />
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                </asp:GridView>
                            </td>
                            </tr>
