...
using RepArrivalVendorWiseDataSetTableAdapters;

public partial class RepArrivalVendorWise : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptArrivalVendorWiseTableAdapter ds = new RptArrivalVendorWiseTableAdapter();
