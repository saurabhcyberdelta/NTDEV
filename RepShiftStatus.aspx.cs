...
using RepShiftStatusDataSetTableAdapters;

public partial class RepShiftStatus : basepage
{
    DataClasses1DataContext tmscontext = new DataClasses1DataContext();
    RptShiftStatusTableAdapter ds = new RptShiftStatusTableAdapter();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ReportDataSource report1DataSource = new ReportDataSource("RepShiftStatusDataSet_RptShiftStatus", ds.GetData(Convert.ToDateTime(Startdate), Convert.ToInt32(FacilityID)));
