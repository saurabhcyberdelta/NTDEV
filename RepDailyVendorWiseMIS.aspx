<%@ Page Language="C#" MasterPageFile="~/eTMSMaster.Master" AutoEventWireup="true"
    CodeFile="RepDailyVendorWiseMIS.aspx.cs" Inherits="RepDailyVendorWiseMIS" Title="Daily vendor wise Pick/ Drop MIS report" %>
    ...
    <table align="center" border="0" width="100%">
        ...
        <tr align="center">
            <td class="heading">
              <div class="gradient2">
                                        <h1>
                                            <span></span>  Display Daily vendor wise Pick/ Drop MIS report
                                        </h1>
                                        <h2>
                                             Allows to Generate vendor wise Pick/ Drop MIS report.
                                        </h2>
                                    </div>
                    ...
                    <tr>
                        <td align="left">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Font-Names="Verdana"
                                ...
                                AsyncRendering="False" ShowBackButton="True"
                                SizeToReportContent="True" Height="400px" ShowZoomControl="False" 
                                ZoomMode="FullPage">
                                <LocalReport ReportPath="RepDailyVendorWiseMISReport.rdlc">                                    
                                </LocalReport>
                            </rsweb:ReportViewer>                            
                        </td>
                    </tr>
