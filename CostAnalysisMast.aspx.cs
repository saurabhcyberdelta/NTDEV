...
public partial class CostAnalysisMast : basepage
{
    ...
    {
        grdManager.DataSource = ds.getcostAnalysis();
        grdManager.DataBind();
    ...
    protected void grdManager_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        ds.deletecostAnalysis(Convert.ToInt32(id));
        BindGrid();
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ds.AddcostAnalysis(txtEmpIdName.Text);
